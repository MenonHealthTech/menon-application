...
import 'package:menon/forms/RegisterAs.dart';
import 'package:menon/widgets/CustomAlert.dart';
import 'package:menon/widgets/CustomLoading.dart';
        ...
        _firebaseAuth.verifyPhoneNumber(
            ...
            verificationCompleted: (PhoneAuthCredential credential) async {
              ...
              Navigator.pushReplacement(context,
                  MaterialPageRoute(builder: (context) => RegisterAs(phone)));
            },
                        ...
                        FlatButton(
                          ...
                          onPressed: () async {
                            Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => RegisterAs(phone)));
                          },
                        )
                      ],
                    );
